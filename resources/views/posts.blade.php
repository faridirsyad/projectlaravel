    ...
    {{-- Search  Input --}}
      ...
      <div class="grid gap-8 lg:grid-cols-3 md:grid-cols-2">
        ...
        <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
              ...
              <p class="mb-5 font-light text-gray-500 dark:text-gray-400">{{ Str::limit($post['body'], 75) }}</p>
              <div class="flex justify-between items-center">
                  ...
                  <a href="/posts/{{ $post['slug'] }}" class="inline-flex items-center text-blue-500 font-medium text-sm text-primary-600 dark:text-primary-500 hover:underline">
                      Read more &raquo;
